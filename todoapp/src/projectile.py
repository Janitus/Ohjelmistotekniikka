...
class Projectile(pygame.sprite.Sprite):
    ...
    def set_size(self, width, height): self.image = pygame.Surface((width, height))
    def set_color(self, r, g, b): self.image.fill((int(r), int(g), int(b)))
    ...
    def check_collision(self):
        if (map.get_collision_by_coordinate(self.position.y, self.position.x)): return True
